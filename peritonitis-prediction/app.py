...
if selection == "Peritonitis Prediction":
    ...
    variables_data = [
        ...
        {"label": "Gender", "peritonitis": "Male", "non-peritonitis": "Female", "p_val": 0.090, "weight": 1, "mean": 1.08, "std_dev": (1.18 - 0.99)/4, "mrf": False},
